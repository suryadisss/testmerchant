...
<jsp:include page='_Header_Gentellela.jsp'>
	<jsp:param name="title" value="AuditTrail - Audit" />
								...
								<div class="form-horizontal">
									...
									<table id="tableviewua" class="table table-hover hidden"
										...
										<thead>
											<tr>
												<td width="30%"><b>Nama Kolom</b></td>
												<td width="35%" id="login" align="left"><b>Rincian Login User</b></td>
												<td width="35%" id="logout" align="right"><b>Rincian Logout User</b></td>
											</tr>
											<tr>
												<td width="30%"><b>Id Pengguna</b></td>
									...
									<table id="tableviewProductInfo"
										...
										<thead>
											...
											<tr>
												<td><b>Dari junmlah pinjaman</b></td>
									...
									<table id="tableviewprioritypayment"
										...
										<thead>
											...
											<tr>
												<td width="30%"><b>Pembayaran menggunakan</b></td>
		...
		$
				.ajax({
					...
					success : function(data) {
						...
						html += '<i class="fa fa-file-excel-o"></i> Unduh semua kes</button>';
						$("#exceldownload").empty(); 
