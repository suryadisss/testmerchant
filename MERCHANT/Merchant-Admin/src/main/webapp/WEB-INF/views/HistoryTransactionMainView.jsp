				...
				<div class="col-xs-12 col-sm-12 col-lg-12">
					...
					<div class="row" style="margin-left:10%" >
							<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input class="form-control" type="text" id="rekening_number"
												required="required" name="rekening_number"
												style="width: 90%; ">
										</div>
									</div>
									</div>
								...
								<div class="searchclass">
									<button id="confirmationButton" class="btn btn-success">Konfirmasi</button>
	...
	$(document)
	  ...
	  $('#confirmationButton').click(function(e){
		  $
			.confirm({
				title : 'Konfirmasi!',
				content : 'Anda yakin ingin membuat transaksi ini void ?',
				buttons : {
					Tidak : function() {
						$
								.alert('Dibatalkan!');
	  ...
	  function confirmVoid(){
			...
			.ajax({
				type : "POST",
				url : "${local_server}/disbursement_batch/reject/disb", 
				data : dtm,
				cache : false,
				beforeSend : function() {
					$("#confirmationButton,#btn-green")
							.html(
									"<i class='fa fa-circle-o-notch fa-spin'></i>  Processing ..");

					$("#confirmationButton,#btn-green").prop("disabled", true);
